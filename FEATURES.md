...
What OpenRoutines does, grouped by the problem each piece solves. The [README](README.md) shows how to use these; [DESIGN.md](DESIGN.md) records the full reasoning behind each decision, including the alternatives we rejected.
