...
func printKnowledgeOverview(mem *knowledge.Knowledge, snap *knowledge.OriginSnapshot) int {
...
func knowledgeInteractive(mem *knowledge.Knowledge, snap *knowledge.OriginSnapshot) int {
	if code := printKnowledgeOverview(mem, snap); code != 0 {
		return code
	}
