...
- This routine does not record events (events: false): never write to memory/events.md, not even a no-op note -- what happened in your runs is not part of the shared record. The other records are still yours to keep current.{{end}}
